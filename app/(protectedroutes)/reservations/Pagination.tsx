...
function Pagination({ reservationsLength }: PaginationProps) {
  ...
  const pageCount = Math.ceil(reservationsLength / PAGE_SIZE);
  ...
  return (
    <div className="flex w-full items-center justify-between">
      <p className="ml-[0.8rem] text-[1.4rem] text-gray-900 dark:text-red-50">
        ...
        of <span className="font-semibold">{reservationsLength}</span> results
      </p>
